...
class TransactionPage:
    ...
    def setup_transaction_page(self):
        ...
        self.add_button = ctk.CTkButton(master=button_frame, text="Ajouter une Transaction", command=self.open_add_transaction)
        self.add_button.pack(side="left", padx=10)

        self.back_button = ctk.CTkButton(master=button_frame, text="Retour", command=self.go_back_to_welcome)
